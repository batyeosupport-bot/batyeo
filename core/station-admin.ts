...
/** Stripe Terminal Location IDs are always prefixed `tml_`; the kiosk otherwise has no way to catch a copy-paste mistake before it tries to pair a reader. */
export function setStripeTerminalLocation(d:Data,stationId:string,locationId:string|null):Station {
 ...
 station.stripeTerminalLocationId=locationId;return station;
}
