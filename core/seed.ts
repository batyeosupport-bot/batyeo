...
export function seedData(passwordHash:string,now=Date.now()):Data {
 ...
 d.partners=[{id:'partner-a',name:'BATYEO Demo Hospitality',city:'Paris · Lyon',commissionBps:null},{id:'partner-b',name:'BATYEO Demo Nightlife',city:'Lille',commissionBps:null}];
