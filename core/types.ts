...
export interface Station { id:string; publicId:string; venueId:string; partnerId:string; online:boolean; failure:FailureMode; capacity:number; provider?:'mock'|'manufacturer'; providerDeviceId?:string|null; providerStatus?:string|null; providerLastSyncedAt?:number|null; lastSeenAt?:number|null; stripeTerminalLocationId?:string|null; }
...
export interface Payment { id:string; rentalId:string; authorizedCents:number; capturedCents:number; releasedCents:number; status:PaymentState; provider?:PaymentProviderName; providerReference?:string|null; error?:string|null; requestedCents?:number; }
