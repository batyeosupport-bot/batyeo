...
import type { VenueBranding, VenuePromo } from './screen';
...
/** MISSING : sortie de sa borne sans aucune location BATYEO (flux natif du fabricant, retrait à la main). Revient AVAILABLE dès qu'une borne la relit. */
export interface Battery { id:string; charge:number; status:'AVAILABLE'|'RENTED'|'MAINTENANCE'|'LOST'|'MISSING'; }
