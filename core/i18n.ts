...
export const WEB_DEFAULT_STRINGS_FR:Readonly<Record<WebStringKey,string>>={
 ...
 web_active_cta:'Trouver une station pour la rendre', web_active_returnHint:'Rendez la batterie dans n’importe quelle borne BATYEO : elle détecte l’insertion et clôture votre location automatiquement.',
